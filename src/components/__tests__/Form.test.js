...
describe("Form", () => {
  ...
  it("validates that the student name is not blank", () => {
    ...
    const { getByText } = render(
      <Form
        interviewers={interviewers} onSave={onSave} student=""
      />
    );
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    const { getByText } = render(
      <Form
        interviewers={interviewers} onSave={onSave} student="Lydia Miller-Jones" interviewer={null}
      />
    );
  ...
  it("calls onSave function when the name and interviewer is defined", () => {
    ...
    const { getByText, queryByText } = render(
      <Form
        interviewers={interviewers} onSave={onSave} student="Lydia Miller-Jones" interviewer={interviewers[0].id}
      />
    );
